...
SECRET_KEY = 'django-insecure-qz@%0e$n*bpxrd8bt7jlo8j-1-w&w!!)g2)q5-8!o08g5!=j#0'
...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount',  # For social accounts (optional)
    'dj_rest_auth',
...
ACCOUNT_EMAIL_VERIFICATION = 'none'  # Can be 'mandatory' if you add email support
